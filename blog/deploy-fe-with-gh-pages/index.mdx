...
<Gif src="https://media.giphy.com/media/3ohzdDls6viEANKHtK/giphy.gif" />
...
<Gif src="https://media.giphy.com/media/l0ErQJblvX9EWNQCA/giphy.gif" />
...
<BigQuote>
  Não sinta vergonha de ser iniciante ou de errar. Os melhores um dia já o
  foram, já erraram e ainda erram! =p
</BigQuote>
...
<div style="width:100%;height:0;padding-bottom:54%;position:relative;">
  <iframe
    width="100%"
    height="300"
    src="//jsfiddle.net/raulfdm/ekhhukkL/embedded/js,html,css,result/dark/"
...
<Gif src="https://media.giphy.com/media/4cQSQYz0a9x9S/giphy.gif" />
...
<Gif src="https://media.giphy.com/media/xT9IgOoJe1q8D9cRsk/giphy.gif" />
